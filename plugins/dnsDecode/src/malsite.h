...
#define DNS_MAL_DOMAIN 1 // 0: check for blacklisted IPs [NOT IMPLEMENTED YET]
                         // 1: check for blacklisted domain names
...
#if DNS_MAL_DOMAIN == 1
#define DNS_TMALFILE "maldm.txt"
#else // DNS_MAL_DOMAIN == 0
#define DNS_TMALFILE "malip.txt"
