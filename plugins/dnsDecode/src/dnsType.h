...
#define DNS_NIMLOC_NB  0x0020 // Nimrod Locator/Netbios
#define NB             0x0020 // Netbios
...
const char *dnsTypeN[] = {"", "A", "NS", "MD", "MF", "CNAME", "SOA", "MB", "MG", "MR", "NULL", "WKS", "PTR", "HINFO", "MINFO", "MX", "TXT", "RP", "AFSDB", "X25", "ISDN", "RT", "NSAP", "NSAPPTR", "SIG", "KEY", "PX", "GPOS", "AAAA", "LOC", "NXT", "EID", "NIMLOC/NB", "SRV", "ATMA", "NAPTR", "KX", "CERT", "A6", "DNAME", "SINK", "OPT", "APL", "DS", "SSHFP", "IPSECKEY", "RRSIG", "NSEC", "DNSKEY", "DHCID", "NSEC3", "NSEC3PAR", "TLSA", "SMIMEA", "HIP", "NINFO", "RKEY", "TALINK", "CDS", "CDNSKEY", "OPENPGPKEY", "CSYNC"};

const char *dnsTypeN63[] = {"SPF", "UINFO", "UID", "GID", "UNSPEC", "NID", "L32", "L64", "LP", "EUI48", "EUI64"};

const char *dnsTypeNF9[] = {"TKEY", "TSIG", "IXFR", "AXFR", "MAILB", "MAILA", "ZONEALL", "URI", "CAA"};

const char *dnsTypeN8000[] = {"TA", "DLV"};
