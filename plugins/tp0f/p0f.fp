...
label = s:unix:Linux:Arch 5.0+
sig   = *:64:0:1460:64240,7:mss,sok,ts,nop,ws:df,id+:0

label = s:unix:Linux:Kali 5.0+
sig   = *:64:0:1460:32120,7:mss,sok,ts,nop,ws:df,id+:0

label = s:unix:Linux:Ubuntu 22.04+
sig   = *:64:0:1460:65535,7:mss,sok,ts,nop,ws:df,id+:0
...
ig   = *:64:0:*:mss*4,1:mss,sok,ts,nop,ws:df,id+:0
...
sig   = *:128:0:1460:64240,8:mss,nop,ws,nop,nop,sok:df,id+:0

label = s:unix:WSL Ubuntu on Windows:10
sig   = *:128:0:1460:64240,7:mss,sok,ts,nop,ws:df,id+:0
...
label = s:win:Windows:2003
sig   = *:128:0:1460:16384,0:mss,nop,ws,nop,nop,ts,nop,nop,sok:df,id+:0
