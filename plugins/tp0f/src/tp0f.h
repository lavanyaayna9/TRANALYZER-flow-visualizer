...
#define TP0F_L34FILE "tp0fL34.txt"
...
//
#define TP0F_MXTTLD 38

// tp0fStat
#define TP0F_TSSIG    0x01 // SYN tp0f rule fired
#define TP0F_TSASIG   0x02 // SYN-ACK tp0f rule fired
#define TP0F_TTLNS    0x10 // Initial TTL maybe non standard 2^n
#define TP0F_ASN      0x40 // IP already seen by tp0f
