...
#define NAT_PMP 1 // Analyze NAT-PMP

/* +++++++++++++++++++++ ENV / RUNTIME - conf Variables +++++++++++++++++++++ */

/*        No env / runtime configuration flags available for stunDecode       */
...
#define NAT_STAT_PMP           0x00010000 // Port Mapping Protocol (PMP)
#define NAT_STAT_SNAPLEN       0x80000000 // packet snapped, analysis incomplete

// NAT type TODO need to analyze reverse flow
// Binding
...
#define STUN_ERR_TO_BF(e, nf) do { \
    switch (e) { \
        ...
        default: \
            nf->err |= 0x80000000; \
            T2_PDBG(plugin_name, "Unhandled error %#04x\n", (e)); \
            break; \
    } \
} while (0)
