...
#include "t2crypto.h" // for T2_MD5_STRLEN
...
// QUIC
#define SSL_ANALYZE_QUIC       0 // analyze TLS 1.3 client/server hello in decrypted QUIC initial packets

// SSL/TLS
#define SSL_EXT_LIST           1 // output the list and number of extensions
#define SSL_MAX_EXT           20 // maximum number of extensions to store

#define SSL_REC_VER            1 // output the list and number of record versions
#define SSL_MAX_REC_VER        3 // maximum number of record versions to store

#define SSL_HAND_VER           1 // output the list and number of handshake versions
#define SSL_MAX_HAND_VER       2 // maximum number of handshake versions to store

#define SSL_SUPP_VER           1 // output the list and number of supported versions
#define SSL_MAX_SUPP_VER       4 // maximum number of supported versions to store

#define SSL_SIG_ALG            1 // output the list and number of signature algorithms
#define SSL_MAX_SIG_ALG       15 // maximum number of signature algorithms to store
...
#define SSL_ALPN_LIST          1 // output the list and number of protocols (ALPN)
#define SSL_ALPS_LIST          1 // output the list and number of protocols (ALPS)
#define SSL_NPN_LIST           1 // output the list and number of protocols (NPN)
#define SSL_MAX_PROTO          6 // maximum number of protocols (ALPN/ALPS/NPN) to store
#define SSL_PROTO_LEN         16 // maximum number of characters per protocol (ALPN/ALPS/NPN)
...
#define SSL_JA4                1 // Output JA4/JA4S fingerprints
#define SSL_JA4_O              0 // Output JA4/JA4S_o fingerprints (original order)
#define SSL_JA4_R              0 // Output JA4/JA4S_r fingerprints (raw)
#define SSL_JA4_RO             0 // Output JA4/JA4S_ro fingerprints (raw, original order)
#define SSL_JA4_STR_LEN      254 // Max length for uncompressed JA4/JA4S signatures (JA4/JA4S_r, JA4/JA4S_ro)
#define SSL_JA4_DLEN          64 // Max length for JA4/JA4S descriptions
...
#define SSL_JA3_DLEN          64 // Max length for JA3 descriptions
...
#define SSL_JA4_LEN             37 // Length for JA4 fingerprints
#define SSL_JA4_TRUNC_HASH_LEN  12 // Length of truncated SHA256 hash
#define SSL_COMPUTE_JA4 (SSL_JA4 == 1 || SSL_JA4_O == 1 || SSL_JA4_R == 1 || SSL_JA4_RO == 1)
...
#define TLSv13_D14   0x7f0e
#define TLSv13_D15   0x7f0f
#define TLSv13_D16   0x7f10
#define TLSv13_D17   0x7f11
#define TLSv13_D18   0x7f12
#define TLSv13_D19   0x7f13
#define TLSv13_D20   0x7f14
#define TLSv13_D21   0x7f15
#define TLSv13_D22   0x7f16
#define TLSv13_D23   0x7f17
#define TLSv13_D24   0x7f18
#define TLSv13_D25   0x7f19
#define TLSv13_D26   0x7f1a
#define TLSv13_D27   0x7f1b
#define TLSv13_D28   0x7f1c
#define TLSv13_FBD23 0xfb17 // Facebook draft 23
#define TLSv13_FBD26 0xfb1a // Facebook draft 26
// DTLS
...
#define DTLSv13      0xfefc

#define SSL_V_MAJOR(v) ((v) >> 8)
#define SSL_V_MINOR(v) ((v) & 0x00ff)

#define SSL_V_IS_DTLS(v) (((v) == DTLSv13) || ((v) == DTLSv12) || ((v) == DTLSv10) || ((v) == DTLSv10_OLD))
#define SSL_V_IS_TLS13_D(v) (((v) >= TLSv13_D14) && ((v) <= TLSv13_D28))
#define SSL_V_IS_TLS13_FBD(v) (((v) == TLSv13_FBD23) || ((v) == TLSv13_FBD26))
#define SSL_V_IS_TLS13(v) ((v) == TLSv13 || SSL_V_IS_TLS13_D(v) || SSL_V_IS_TLS13_FBD(v))
#define SSL_V_IS_SSL(v) ((((v) >= SSLv3) && ((v) <= TLSv12)) || SSL_V_IS_TLS13(v))
#define SSL_V_IS_VALID(v) (SSL_V_IS_SSL((v)) || SSL_V_IS_DTLS((v)))

#define SSL_IS_GREASE(v) ((((v) & 0x0f0f) == 0x0a0a) && ((((v) & 0xf000) >> 8) == ((v) & 0x00f0)))

// ALPN Protocols (network order)
// https://www.iana.org/assignments/tls-extensiontype-values/tls-extensiontype-values.xhtml#alpn-protocol-ids
#define SSL_PROTO_HTTP2    0x6832             // h2
#define SSL_PROTO_HTTP3    0x6833             // h3: HTTP/3
#define SSL_PROTO_QUIC     0x6871             // hq: HTTP/0.9/1.1 over QUIC
#define SSL_PROTO_DOQ      0x646f71           // doq
#define SSL_PROTO_DOT      0x646f74           // dot
#define SSL_PROTO_FTP      0x667470           // ftp
#define SSL_PROTO_H2C      0x683263           // h2c
#define SSL_PROTO_IRC      0x697263           // irc
#define SSL_PROTO_SMB      0x736d62           // smb
#define SSL_PROTO_ACME     0x61636d65         // acme
#define SSL_PROTO_APNS     0x61706e73         // apns
#define SSL_PROTO_COAP     0x636f6170         // coap
#define SSL_PROTO_DICO     0x6469636f         // dico(m)
#define SSL_PROTO_HTTP     0x68747470         // http
#define SSL_PROTO_IMAP     0x696d6170         // imap
#define SSL_PROTO_MQTT     0x6d717474         // mqtt
#define SSL_PROTO_NNSP     0x6E6E7370         // nnsp
#define SSL_PROTO_NNTP     0x6E6E7470         // nntp
#define SSL_PROTO_POP3     0x706f7033         // pop3
#define SSL_PROTO_SIP2     0x7369702f         // sip/
#define SSL_PROTO_SPDY     0x73706479         // spdy
#define SSL_PROTO_STUN     0x7374756e         // stun
#define SSL_PROTO_TDS8     0x7464732f         // tds/
#define SSL_PROTO_XMPP     0x786d7070         // xmpp
#define SSL_PROTO_NTSKE    0x6e74736b652f     // ntske/
#define SSL_PROTO_SUNRPC   0x73756e727063     // sunrpc
#define SSL_PROTO_WEBRTC   0x776562727463     // webrtc
#define SSL_PROTO_CWEBRTC  0x632d776562727463 // c-webrtc
...
#define SSL_HT_HELLO_EXT_SUPPORTED_VERSION      0x002b
...
#define SSL_HT_HELLO_EXT_ALPS                   0x4469
...
#define SSL_AD_DECRYPTION_FAIL         0x15
#define SSL_AD_RECORD_OVERFLOW         0x16
...
#define SSL_AD_USER_CANCELED           0x5a
#define SSL_AD_NO_RENEGOTIATION        0x64
#define SSL_AD_MISSING_EXTENSION       0x6d /* fatal (TLS 1.3) */
// 0x6e-0x73 - [RFC3546]
#define SSL_AD_UNSUPPORTED_EXTENSION   0x6e
#define SSL_AD_CERT_UNOBTAINABLE       0x6f
#define SSL_AD_UNRECOGNIZED_NAME       0x70
#define SSL_AD_BAD_CERT_STATUS_RESP    0x71
#define SSL_AD_BAD_CERT_HASH_VALUE     0x72
#define SSL_AD_UNKNOWN_PSK_IDENTITY    0x73 /* fatal */
#define SSL_AD_CERT_REQUIRED           0x74 /* fatal (TLS 1.3) */
...
// sslStat status variable
#define SSL_STAT_VERSION_MISMATCH    0x00000001 // Message had mismatched version
#define SSL_STAT_REC_TOO_LONG        0x00000002 // Record was too long (max 16384)
#define SSL_STAT_MALFORMED           0x00000004 // Record was malformed, eg, invalid value
#define SSL_STAT_CERT_EXPIRED        0x00000008 // Certificate had expired
#define SSL_STAT_AL_FATAL            0x00000010 // Connection closed due to fatal alert
#define SSL_STAT_RENEGOTIATION       0x00000020 // Connection was renegotiated (existed before)
#define SSL_STAT_NO_HEARTBEAT        0x00000040 // Peer not allowed to send heartbeat requests
#define SSL_STAT_CIPHERL_TRUNC       0x00000080 // Cipher list truncated... increase SSL_MAX_CIPHER
#define SSL_STAT_EXTL_TRUNC          0x00000100 // Extension list truncated... increase SSL_MAX_EXT
#define SSL_STAT_PROTOL_TRUNC        0x00000200 // Protocol list truncated... increase SSL_MAX_PROTO
#define SSL_STAT_PROTON_TRUNC        0x00000400 // Protocol list truncated... increase SSL_PROTO_LEN
#define SSL_STAT_EC_TRUNC            0x00000800 // EC or EC formats list truncated... increase SSL_MAX_EC or SSL_MAX_EC_FORMATS
#define SSL_STAT_BLIST               0x00001000 // Cert. is blacklisted
#define SSL_STAT_INSEC_WEAK_CIPHER   0x00002000 // Insecure or weak cipher
#define SSL_STAT_WEAK_PROTO          0x00004000 // SSLv2.0, SSLv3.0 // (TLSv1.0?)
#define SSL_STAT_WEAK_KEY            0x00008000 // Weak key detected
#define SSL_STAT_SIG_ALG_TRUNC       0x00010000 // Signature algorithm list truncated... increase SSL_MAX_SIG_ALG
#define SSL_STAT_SUPP_VER_TRUNC      0x00020000 // Supported versions list truncated... increase SSL_MAX_SUPP_VER
#define SSL_STAT_SNAP                0x00040000 // Packet snapped, decoding failed
#define SSL_STAT_JA3_FAIL            0x00080000 // Failed to compute JA3 fingerprint... increase SSL_JA3_STR_LEN
#define SSL_STAT_JA4_FAIL            0x00100000 // Failed to compute JA4 fingerprint
#define SSL_STAT_JA4_A_OK            0x00200000 // JA4_a successfully computed
#define SSL_STAT_JA4_B_OK            0x00400000 // JA4_b successfully computed
#define SSL_STAT_JA4_C_OK            0x00800000 // JA4_c successfully computed
#define SSL_STAT_INSECURE_CIPHER     0x01000000 // Insecure cipher (should NEVER be used)
#define SSL_STAT_WEAK_CIPHER         0x02000000 // Weak cipher (should not be used)
#define SSL_STAT_SECURE_CIPHER       0x04000000 // Secure cipher
#define SSL_STAT_RECOMMENDED_CIPHER  0x08000000 // Perfect Forward Secrecy (PFS) ciphers
#define SSL_STAT_JA4_TRUNC           0x10000000 // JA4/JA4S fingerprint truncated... increase SSL_JA4_STR_LEN
#define SSL_STAT_REC_VER_TRUNC       0x20000000 // Record versions list truncated... increase SSL_MAX_REC_VER
#define SSL_STAT_HAND_VER_TRUNC      0x40000000 // Handshake versions list truncated... increase SSL_MAX_HAND_VER

// sslProto proto variable
#define SSL_STAT_PROTO_HTTP     0x00000001 // HTTP (HTTP/0.9, HTTP/1.0, HTTP/1.1)
#define SSL_STAT_PROTO_HTTP2    0x00000002 // HTTP/2 (h2, h2c)
#define SSL_STAT_PROTO_HTTP3    0x00000004 // HTTP/3 (h3), HTTP/0.9/1.1 over QUIC (hq)
#define SSL_STAT_PROTO_SPDY     0x00000008 // SPDY
#define SSL_STAT_PROTO_IMAP     0x00000010 // IMAP
#define SSL_STAT_PROTO_POP3     0x00000020 // POP3
#define SSL_STAT_PROTO_FTP      0x00000040 // FTP
#define SSL_STAT_PROTO_XMPP     0x00000080 // XMPP jabber
#define SSL_STAT_PROTO_STUN     0x00000100 // STUN/TURN
#define SSL_STAT_PROTO_APNS     0x00000200 // Apple Push Notification Service
#define SSL_STAT_PROTO_WEBRTC   0x00000400 // WebRTC Media and Data
#define SSL_STAT_PROTO_COAP     0x00000800 // CoAP
#define SSL_STAT_PROTO_MANSIEVE 0x00001000 // ManageSieve
#define SSL_STAT_PROTO_RTP      0x00002000 // RTP or RTCP (guessed by the presence of the use_srtp extension)
#define SSL_STAT_PROTO_OVPN     0x00004000 // OpenVPN (guessed by being able to decode the protocol)
#define SSL_STAT_PROTO_MQTT     0x00008000 // OASIS Message Queuing Telemetry Transport (MQTT)
#define SSL_STAT_PROTO_ACME     0x00010000 // acme-tls/1
#define SSL_STAT_PROTO_DICO     0x00020000 // DICOM
#define SSL_STAT_PROTO_NNTP     0x00040000 // NNTP (reading) or NNTP (transit)
#define SSL_STAT_PROTO_SIP2     0x00080000 // SIP
#define SSL_STAT_PROTO_TDS8     0x00100000 // Tabular Data Stream Protocol (TDS)
#define SSL_STAT_PROTO_DOQ      0x00200000 // DNS over Dedicated QUIC Connections (DoQ)
#define SSL_STAT_PROTO_DOT      0x00400000 // DNS-over-TLS (DoT)
#define SSL_STAT_PROTO_IRC      0x00800000 // IRC
#define SSL_STAT_PROTO_SMB      0x01000000 // SMB
#define SSL_STAT_PROTO_SUNRPC   0x02000000 // SUNRPC
#define SSL_STAT_PROTO_NTSKE    0x04000000 // Network Time Security Key Establishment
#define SSL_STAT_PROTO_GREASE   0x40000000 // GREASE value
#define SSL_STAT_PROTO_UNKNOWN  0x80000000 // ALPN matches none of the above

// sslVuln vulnerabilities variable
...
#define SSL_SET_AD_BF(ssl, a) \
    switch ((a)) { \
        case SSL_AD_CLOSE_NOTIFY:            ssl->alert |= 0x0000000000000001; break; \
        case SSL_AD_UNEXPECTED_MSG:          ssl->alert |= 0x8000000000000002; break; \
        case SSL_AD_BAD_RECORD_MAC:          ssl->alert |= 0x8000000000000004; break; \
        case SSL_AD_DECRYPTION_FAIL:         ssl->alert |= 0x0000000000000008; break; \
        case SSL_AD_RECORD_OVERFLOW:         ssl->alert |= 0x0000000000000010; break; \
        case SSL_AD_DECOMPRESSION_FAIL:      ssl->alert |= 0x8000000000000020; break; \
        case SSL_AD_HANDSHAKE_FAIL:          ssl->alert |= 0x8000000000000040; break; \
        case SSL_AD_NO_CERT:                 ssl->alert |= 0x0000000000000080; break; \
        case SSL_AD_BAD_CERT:                ssl->alert |= 0x0000000000000100; break; \
        case SSL_AD_UNSUPPORTED_CERT:        ssl->alert |= 0x0000000000000200; break; \
        case SSL_AD_CERT_REVOKED:            ssl->alert |= 0x0000000000000400; break; \
        case SSL_AD_CERT_EXPIRED:            ssl->alert |= 0x0000000000000800;        \
                                             ssl->stat  |= SSL_STAT_CERT_EXPIRED;     \
                                                                               break; \
        case SSL_AD_CERT_UNKNOWN:            ssl->alert |= 0x0000000000001000; break; \
        case SSL_AD_ILLEGAL_PARAM:           ssl->alert |= 0x8000000000002000; break; \
        case SSL_AD_UNKNOWN_CA:              ssl->alert |= 0x8000000000004000; break; \
        case SSL_AD_ACCESS_DENIED:           ssl->alert |= 0x8000000000008000; break; \
        case SSL_AD_DECODE_ERROR:            ssl->alert |= 0x8000000000010000; break; \
        case SSL_AD_DECRYPT_ERROR:           ssl->alert |= 0x0000000000020000; break; \
        case SSL_AD_EXPORT_RESTRICTION:      ssl->alert |= 0x8000000000040000; break; \
        case SSL_AD_PROTOCOL_VERSION:        ssl->alert |= 0x8000000000080000; break; \
        case SSL_AD_INSUFFICIENT_SECURITY:   ssl->alert |= 0x8000000000100000; break; \
        case SSL_AD_INTERNAL_ERROR:          ssl->alert |= 0x8000000000200000; break; \
        case SSL_AD_USER_CANCELED:           ssl->alert |= 0x0000000000400000; break; \
        case SSL_AD_NO_RENEGOTIATION:        ssl->alert |= 0x0000000000800000; break; \
        case SSL_AD_UNSUPPORTED_EXTENSION:   ssl->alert |= 0x0000000001000000; break; \
        case SSL_AD_INAPPROPRIATE_FALLBACK:  ssl->alert |= 0x8000000002000000; break; \
        case SSL_AD_CERT_UNOBTAINABLE:       ssl->alert |= 0x0000000004000000; break; \
        case SSL_AD_UNRECOGNIZED_NAME:       ssl->alert |= 0x0000000008000000; break; \
        case SSL_AD_BAD_CERT_STATUS_RESP:    ssl->alert |= 0x0000000010000000; break; \
        case SSL_AD_BAD_CERT_HASH_VALUE:     ssl->alert |= 0x0000000020000000; break; \
        case SSL_AD_UNKNOWN_PSK_IDENTITY:    ssl->alert |= 0x8000000040000000; break; \
        case SSL_AD_NO_APPLICATION_PROTOCOL: ssl->alert |= 0x8000000080000000; break; \
        case SSL_AD_MISSING_EXTENSION:       ssl->alert |= 0x8000000100000000; break; \
        case SSL_AD_CERT_REQUIRED:           ssl->alert |= 0x8000000200000000; break; \
        default: break; \
    }
...
#if SSL_REC_VER == 1
    uint16_t num_rec_ver;
    uint16_t rec_ver[SSL_MAX_REC_VER]; // record versions list
#endif // SSL_REC_VER == 1

#if SSL_HAND_VER == 1
    uint16_t num_hand_ver;
    uint16_t hand_ver[SSL_MAX_HAND_VER]; // handshake versions list
#endif // SSL_HAND_VER == 1

#if SSL_EXT_LIST == 1 || SSL_JA3 == 1 || SSL_COMPUTE_JA4 == 1
    uint16_t num_ext;
    uint16_t ext_list[SSL_MAX_EXT]; // extensions list
#endif // SSL_EXT_LIST == 1 || SSL_JA3 == 1 || SSL_COMPUTE_JA4 == 1

#if SSL_SUPP_VER == 1 || SSL_COMPUTE_JA4 == 1
    uint16_t num_supp_ver;
    uint16_t supp_ver[SSL_MAX_SUPP_VER]; // supported versions list
#endif // SSL_SUPP_VER == 1 || SSL_COMPUTE_JA4 == 1

#if SSL_SIG_ALG == 1 || SSL_COMPUTE_JA4 == 1
    uint16_t num_sig_alg;
    uint16_t sig_alg[SSL_MAX_SIG_ALG]; // signature hash algorithm list
#endif // SSL_SIG_ALG == 1 || SSL_COMPUTE_JA4 == 1
...
#if SSL_ALPN_LIST == 1 || SSL_COMPUTE_JA4 == 1
    uint16_t num_alpn;
    char alpn_list[SSL_MAX_PROTO][SSL_PROTO_LEN + 1]; // ALPN list
#endif // SSL_ALPN_LIST == 1 || SSL_COMPUTE_JA4 == 1

#if SSL_ALPS_LIST == 1
    uint16_t num_alps;
    char alps_list[SSL_MAX_PROTO][SSL_PROTO_LEN + 1]; // ALPS list
#endif // SSL_ALPS_LIST

#if SSL_NPN_LIST == 1
    uint16_t num_npn;
    char npn_list[SSL_MAX_PROTO][SSL_PROTO_LEN + 1];  // NPN list
#endif // SSL_NPN_LIST

    // cipher
    uint16_t cipher;    // preferred (client) / negotiated (server) cipher (see sslCipher.h)

#if SSL_CIPHER_LIST == 1 || SSL_JA3 == 1 || SSL_COMPUTE_JA4 == 1
    uint16_t num_cipher;
    uint16_t cipher_list[SSL_MAX_CIPHER]; // cipher list (see sslCipher.h)
#endif // SSL_CIPHER_LIST == 1 || SSL_JA3 == 1
...
#if SSL_JA4 == 1
    char ja4[SSL_JA4_LEN + 1];
    char ja4_desc[SSL_JA4_DLEN + 1];
#endif

#if SSL_JA4_O == 1
    char ja4_o[SSL_JA4_LEN + 1];  // original order
#endif

#if SSL_JA4_R == 1
    char ja4_r[SSL_JA4_STR_LEN + 1];  // raw
#endif

#if SSL_JA4_RO == 1
    char ja4_ro[SSL_JA4_STR_LEN + 1]; // raw, original order
#endif

#if SSL_JA3 == 1
    //char ja3_fingerprint[1024];
    char ja3_desc[SSL_JA3_DLEN + 1];
    char ja3_hash[T2_MD5_STRLEN + 1]; // md5
#if SSL_JA3_STR == 1
    char ja3_str[SSL_JA3_STR_LEN + 1];
#endif
#endif // SSL_JA3 == 1
...
#if SSL_BLIST == 1
    char blist_cat[SSL_BLIST_LEN + 1];
#endif // SSL_BLIST == 1
