...
#define ICMP_TC_MD     0 // Type code representation:
                         //     0: bitfield,
                         //     1: explicit array of type code,
                         //     2: type code statistics [NOT IMPLEMENTED YET]
#define ICMP_NUM      10 // Number of type and code info / flow (require ICMP_TC_MD == 1)
#define ICMP_FDCORR    1 // Flow direction correction
#define ICMP_PARENT    1 // Resolve the parent flow
#define ICMP_STATFILE  1 // Print global ICMP statistics in a separate file

/* +++++++++++++++++++++ ENV / RUNTIME - conf Variables +++++++++++++++++++++ */

#define ICMP_NOCODE "-"              // Symbol to use to represent the absence of a code
#define ICMP_SUFFIX "_icmpStats.txt" // Suffix for output file
...
#define ICMP4_AHST_ADDR       6 // Alternate Host Address
#define ICMP4_ECHO            8 // Echo Request
#define ICMP4_RTR_ADVC        9 // Router advertisement
#define ICMP4_RTR_SLCT       10 // Router selection
...
#define ICMP4_DTGRM_CNV_ERR  31 // Datagram Conversion Error
#define ICMP4_PHOTURIS       40 // Photuris (Key exchange)
#define ICMP4_SEAMOBY        41 // Seamoby
#define ICMP4_EECHO          42 // Extended Echo Request
#define ICMP4_EECHO_REPLY    43 // Extended Echo Reply
...
#define ICMP4_NET_UNKNOWN     6 // Network Unkown
#define ICMP4_HOST_UNKNOWN    7 // Host Unkown
#define ICMP4_HOST_ISOLATED   8 // How Isolated
#define ICMP4_NET_ANO         9 //
#define ICMP4_HOST_ANO       10 //
#define ICMP4_NET_UNR_TOS    11 // Network Unreachable due to ToS
#define ICMP4_HOST_UNR_TOS   12 // Host Unreachable due to ToS
...
#define ICMP4_EXC_FRAGTIME    1 // Fragment reassembly time exceeded

// Codes for PHOTURIS
#define ICMP4C_PH_BADSPI       0 // Bad SPI
#define ICMP4C_PH_AUTH_FAIL    1 // Authentication failed
#define ICMP4C_PH_PRSS_FAIL    2 // Decompression failed
#define ICMP4C_PH_DCRPT_FAIL   3 // Decryption failed
#define ICMP4C_PH_ND_AUTHEN    4 // Need authentication
#define ICMP4C_PH_ND_AUTHOR    5 // Need authorization

// Codes for Extended Echo Reply
#define ICMP4C_ER_NOERR        0 // No Error
#define ICMP4C_ER_MAL_QRY      1 // Malformed Query
#define ICMP4C_ER_NOINT        2 // No Such Interface
#define ICMP4C_ER_NO_TBL_ENTRY 3 // No Such Table Entry
#define ICMP4C_ER_MLT_I_S_QRY  4 // Multiple Interfaces Satisfy Query
...
// Malware codes
#define LOKISEQ 0xf001
#define ICMPSSH "OpenSSH"

#define ICMPSSHLEN (sizeof(ICMPSSH)-1)
...
// icmpStat status variable
#define ICMP_STAT_ICMP 0x01 // Flow is ICMP
#define ICMP_STAT_WANG 0x10 // WANG2 Microsoft bandwidth test
#define ICMP_SEQ_ABNRM 0x20 // ICMP ECHO Seq Num abnormal increment
#define ICMP_COV_LOKI  0x40 // Embedded LOKI covert channel
#define ICMP_COV_SSH   0x80 // Embedded SSH covert channel
