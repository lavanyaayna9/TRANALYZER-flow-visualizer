...
#define MB_DEBUG      0 // Print debug messages
...
#define MB_UNIQ_FUNC  0 // Aggregate multiply defined function codes
#define MB_NUM_FEX    0 // Number of function codes which caused exceptions to store (0 to hide modbusFEx)
#define MB_UNIQ_FEX   0 // Aggregate multiply defined function codes which caused exceptions
#define MB_NUM_EX     0 // Number of exception codes to store (0 to hide modbusExC)
#define MB_UNIQ_EX    0 // Aggregate multiply defined exception codes

/* +++++++++++++++++++++ ENV / RUNTIME - conf Variables +++++++++++++++++++++ */

/*         No env / runtime configuration flags available for modbus          */
...
#if MB_DEBUG == 1
#define MB_DBG(format, args...) T2_PINF(plugin_name, format, ##args)
#else // MB_DEBUG == 0
