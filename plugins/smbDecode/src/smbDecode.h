...
#define SMB_STAT_WFSMB1    0x2000 // SMB1 files present
#define SMB_STAT_WFSMB2    0x4000 // SMB2 files present
...
typedef struct {
    ...
    char nativeos[SMB_NATIVE_NAME_LEN+1];
    char nativelanman[SMB_NATIVE_NAME_LEN+1];
    char primarydomain[SMB_NATIVE_NAME_LEN+1];

    // GSS-API/NTLMSSP
    char target_name[SMB_NATIVE_NAME_LEN+1];
    char domain_name[SMB_NATIVE_NAME_LEN+1];
    char user_name[SMB_NATIVE_NAME_LEN+1];
    char host_name[SMB_NATIVE_NAME_LEN+1];
    // NTLM Authentication
