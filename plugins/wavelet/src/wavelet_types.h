...
#include "define_global.h" // for WPREC, DB[1234]
...
// WAVELETS[] is the array with all the predefined wavelets
// The order *MUST* be the same as in the enum (DB1, DB2, DB3, DB4) in define_global.h
