...
#ifndef T2_T2BUF_H_INCLUDED
#define T2_T2BUF_H_INCLUDED
...
#define t2buf_rewind(buf) t2buf_seek(buf, 0, SEEK_SET)
...
/*
 * Similar to memmem, finds an occurrence of needle in the bytes left in the buffer and consumes every
