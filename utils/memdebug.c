...
#include <stdio.h>   // for fprintf, stderr, NULL, size_t
#include <stdlib.h>  // for free, malloc, realloc
#include <string.h>  // for memcpy, memcmp, strncpy, strlen, memset

#include "uthash.h"  // for UT_hash_handle, UT_hash_table, UT_hash_bucket
