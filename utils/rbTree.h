...
/*
 * This implementation provides the construction of multiple Red-Black trees
 * out of a "pool" of preallocated tree nodes.
 */

#ifndef T2_RBTREE_H_INCLUDED
#define T2_RBTREE_H_INCLUDED
...
#define RBT_ROTATION 0 // activate the Red-Black Tree feature of rotating an unbalanced tree
