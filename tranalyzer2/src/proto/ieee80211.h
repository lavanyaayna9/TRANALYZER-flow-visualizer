...
#ifndef T2_IEEE80211_H_INCLUDED
#define T2_IEEE80211_H_INCLUDED

#include <stdbool.h>         // for bool
#include <stdint.h>          // for uint8_t, uint16_t

#include "networkHeaders.h"  // for ETH_ALEN
...
uint8_t *t2_process_ieee80211 (uint8_t *pktptr, bool big_endian, packet_t *packet) __attribute__((__nonnull__(1, 3)));

#endif // T2_IEEE80211_H_INCLUDED
