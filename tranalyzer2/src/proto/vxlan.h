...
#ifndef T2_VXLAN_H_INCLUDED
#define T2_VXLAN_H_INCLUDED
...
bool     t2_is_vxlan      (uint16_t sport, uint16_t dport)    __attribute__((__const__));
uint8_t *t2_process_vxlan (uint8_t *pktptr, packet_t *packet) __attribute__((__nonnull__(1, 2)));

#endif // T2_VXLAN_H_INCLUDED
